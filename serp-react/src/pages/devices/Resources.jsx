...
const Resources = () => {
  ...
  const handleModalOpen = (modelToOpen, resourceID) => {
    switch (modelToOpen) {
      case "create":
        ...
        break;
      case "edit":
        const resourceSel = resources.filter(
  ...
  const handleAddResource = async (event) => {
    ...
    try {
      ...
      console.log(
        "Error in Create new Emergency while creating emergency",
        err,
      );
      handleModalClose();
    }
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 2 }}>
          ...
          <Button
            ...
            disabled={statusFetchResources === "succeeded" ? false : true}
            sx={{
              "&:disabled": {
              ...
              >
                ...
                <Button
                  ...
                  disabled={
                    ...
                    !formData.actual_latitude ||
                    !formData.actual_longitude
                  }
                >
                  Create
                </Button>
            ...
            filteredResources.map((resource) => (
              <Grid item xs={12} sm={6} md={4} key={resource.id}>
                <Card>
                  ...
                  />
                  <CardContent
                    sx={{ position: "relative", pb: "16px !important" }}
                  >
                    <Typography variant="body2" color="text.secondary">
                      Lat: {resource.location_resource_data.latitude} Long:{" "}
                    ...
                    >
                      <img
                        src={addPrefix(`${process.env.PUBLIC_URL}/resources/${
                          resource.resource_type === "Ambulance"
                            ? "Ambulancia.png"
                            : resource.resource_type === "Police"
                              ? "Policia.png"
                              : resource.resource_type === "Firetruck"
                                ? "Bomberos.png"
