        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <Paper sx={{ p: 2, height: "100%" }}>
              ...
              <List>
                <ListItem>
                  <ListItemIcon>{renderSignalIcon()}</ListItemIcon>
                  <ListItemText
                ...
                <ListItem>
                  <ListItemIcon>
                    <BatteryIcon
                      color={qosStatus.battery > 20 ? "success" : "error"}
                    />
                  </ListItemIcon>
                  <ListItemText
                    primary="Battery"
                ...
                <>
                  <Card variant="outlined" sx={{ mb: 3 }}>
                    <CardContent>
                      ...
                      >
                        ...
                        <Chip
                          label={
                            myEmergency.status === "active"
                              ? "Activa"
                              : myEmergency.status === "pending"
                                ? "Pendent"
                                : "Resolta"
                          }
                          color={
                  ...
                  <Box sx={{ height: 300 }}>
                    ...
                    >
                      ...
                      />
                      <Marker
                        position={[myEmergency.latitude, myEmergency.longitude]}
                      >
                        <Popup>
                          <Typography variant="subtitle1">
                            {myEmergency.title}
