...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["actual_address"], ["address.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["actual_location"], ["location.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["normal_address"], ["address.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["normal_location"], ["location.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("CRITICAL", "HIGH", "MEDIUM", "LOW", name="prioritytype"),
            nullable=True,
        ),
        sa.Column(
            "emergency_type",
        ...
        sa.Column(
            "status",
            sa.Enum(
                "ACTIVE", "PENDING", "SOLVED", "ARCHIVED", name="statustype"
            ),
            nullable=True,
        ),
        ...
        sa.Column("time_updated", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["address_destination"], ["address.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["address_emergency"], ["address.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["address_resource"], ["address.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["destination_id"], ["resource.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["location_destination"], ["location.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["location_emergency"], ["location.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["location_resource"], ["location.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["resource_id"], ["resource.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
